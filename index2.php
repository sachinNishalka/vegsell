...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#myPage">GoviPala</a>
        </div>
        ...
        <div class="row">
            <div class="col-md-4">
                <figure class="card card-product">
                    <div class="img-wrap"><img src="./img/courgettes.png"></div>
            ...
            <div class="col-md-4">
                <figure class="card card-product">
                    <div class="img-wrap"><img src="./img/eggplant.png"> </div>
                    <figcaption class="info-wrap">
            ...
            <div class="col-md-4">
                <figure class="card card-product">
                    <div class="img-wrap"><img src="./img/okra.png"></div>
                    <figcaption class="info-wrap">
